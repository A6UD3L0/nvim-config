...
-- Return a proper plugin spec that's compatible with lazy.nvim
return {
  name = "adhd_friendly_theme",
  -- Required for lazy.nvim
  config = function() end,
  
  -- Our color palette and functions, accessible through module.colors
  colors = {
    -- Calming Base Colors
  ...
  setup = function()
    -- Store reference to module to access colors
    local M = require("plugins.adhd_friendly_theme")
